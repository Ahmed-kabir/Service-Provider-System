...
<!--                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>--><?php //echo $category->category_name?><!--</a>-->
<!--                        <ul class="sub-menu children dropdown-menu">-->
<!--                            --><?php //foreach ($sub_category as $sub_category) {?>
<!--                                --><?php //if($category->id==$sub_category->category_name) {?>
<!--                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>--><?php //echo $sub_category->sub_category_name?><!--</a>-->
<!--<!--                        <li><i class="fa fa-puzzle-piece"></i><a href="-->--><?php ////echo base_url()?><!--<!--Welcome/show_category/-->--><?php ////echo $category->id?><!--<!--">-->--><?php ////echo $category->sub_category_name?><!--<!--</a></li>-->-->
<!--                            --><?php //}?>
<!--                            --><?php //} ?>
<!---->
<!--                    </ul>-->
