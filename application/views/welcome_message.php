...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!--banner slider  -->
    <link href="<?php echo base_url('frontEnd/css/JiSlider.css')?>" rel="stylesheet">
    <!-- //banner-slider -->
    <link href="<?php echo base_url('frontEnd/css/font-awesome.css')?>" rel="stylesheet" type="text/css" media="all" />
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="<?php echo base_url('')?>home_controller/service">services</a>
                        </li>
                        <li>
    ...
    <div class="footer-dot">
        <div class="container">
            <div class="footer-bottom">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 footer-grid1 ftr-img">
                    ...
                    <ul>
                        <li>
                            <a href="single.html">
                                <img src="<?php echo base_url('frontEnd/images/t1.jpg')?>" alt=" " class="img-responsive" />
                            </a>
                        </li>
                        <li>
                            <a href="single.html">
                                <img src="<?php echo base_url('frontEnd/images/t2.jpg')?>" alt=" " class="img-responsive" />
                            </a>
                        </li>
                        <li>
                            <a href="single.html">
                                <img src="<?php echo base_url('frontEnd/images/t3.jpg')?>" alt=" " class="img-responsive" />
                            </a>
                        </li>
                        <li>
                            <a href="single.html">
                                <img src="<?php echo base_url('frontEnd/images/t4.jpg')?>" alt=" " class="img-responsive" />
                            </a>
                        </li>
                        <li>
                            <a href="single.html">
            ...
            <div class="agileinfo-subscribe-grid text-center">
                <img src="<?php echo base_url('frontEnd/')?>images/mail.png" alt="">
...
<!--//footer  -->
<!-- js -->
<script src="<?php echo base_url('frontEnd/js/jquery-2.2.3.min.js')?>"></script>
<!-- //js-->
<!--banner-slider-->
<script src="<?php echo base_url('frontEnd/js/JiSlider.js')?>"></script>
<script>
...
<script  src="<?php echo base_url('frontEnd/js/move-top.js')?>"></script>
<script  src="<?php echo base_url('frontEnd/js/easing.js')?>"></script>
<script>
...
<script  src="<?php echo base_url('frontEnd/js/SmoothScroll.min.js')?>"></script>
