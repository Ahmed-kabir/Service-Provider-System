...
<head>
    ...
    <!-- Custom Theme files -->
    <link href="<?php echo base_url('user_login/css/style.css')?>" rel="stylesheet" type="text/css" media="all" />
    <!-- //Custom Theme files -->
    <!-- web font -->
...
<div class="main-w3layouts wrapper">
    ...
    <div class="main-agileinfo">
        <div class="agileits-top">
            ...
            <p>Don't have an Account? <a href="<?php echo base_url('Welcome/user_login')?>"> Login Now!</a></p>
        </div>
    </div>
    <!-- copyright -->
